"""
# This file is used to plot the L2 homoclinic second cut (Using experimental parameters)
# Coded By: KK
...
LevelPin=3
println("The energy level we are using is: $(HamiltonianEDP(POL2[:,LevelPin],p_nf_edp))")
POL2[:,LevelPin]
## Calculate the PO using the initial condition you chose
Data_Period2,POData2,eigMono2,eigVecMono2,MonoT2=GetValMonoE(POL2[:,LevelPin],nx,cb1,tspan,p_nf_edp)
...
Stable=1
Inc1_2=GetPeriodMono(Data_Period2[1:4,:],δV,positive,Stable,vecU1,vecS1,gap)
...
backward=0
@time TrajVarInc1_pos_unstable_NoFric=SimulateManifold(Inc1_1,p_nf_edp,backward,Tsim,everystepsave,cb_cut2,experimental=true)
# Simulate the trajectory backward
backward=1
@time TrajVarInc1_pos_stable_NoFric=SimulateManifold(Inc1_2,p_nf_edp,backward,Tsim,everystepsave,cb_cut1,experimental=true)

## Plot the results
PoincarPlot=Scene()
Axis=0
CutDataL1_Unstable,PoincarPlot=MakiePlotFinalPoint(PoincarPlot,TrajVarInc1_pos_unstable_NoFric,col_p,Axis,LinePlot=1)
CutDataL1_Stable,PoincarPlot=MakiePlotFinalPoint(PoincarPlot,TrajVarInc1_pos_stable_NoFric,col_o,Axis,LinePlot=1)
#
...
Mod=0;Transform=0
mks=1;lw=2;lineplot=1;gap_line=100
MakiePlotMono(MonoPlot,POData2,TrajVarInc1_pos_unstable_NoFric,col_p,ThreeD,AxisNum1,AxisNum2,AxisNum3,Mod,Transform,mks,lineplot,lw,gap=gap_line)
MakiePlotMono(MonoPlot,POData2,TrajVarInc1_pos_stable_NoFric,col_o,ThreeD,AxisNum1,AxisNum2,AxisNum3,Mod,Transform,mks,lineplot,lw,gap=gap_line)
...
#@save "Results/EDP_Eng_0_2__Tsim_$(Tsim)_cb3_cb4.jld2" TrajVarInc1_pos_unstable_NoFric_SecondCut Inc1_1
#@time @load "Results/EDP_Eng_0_2__Tsim_$(Tsim)_cb3_cb4.jld2" TrajVarInc1_pos_unstable_NoFric_SecondCut Inc1_1
...
@save "Results/EDP_Eng_0_2__Tsim_$(Tsim)_cb3.jld2" TrajVarInc1_pos_unstable_NoFric_SecondCut_NoStop Inc1_1
@time @load "Results/EDP_Eng_0_2__Tsim_$(Tsim)_cb3.jld2" TrajVarInc1_pos_unstable_NoFric_SecondCut_NoStop Inc1_1

## Now plot preview the tube
MonoPlot=Scene()
gap_line=100
MakiePlotMono(MonoPlot,POData2,TrajVarInc1_pos_unstable_NoFric_SecondCut,col_p,ThreeD,AxisNum1,AxisNum2,AxisNum3,Mod,Transform,mks,lineplot,lw,gap=gap_line)
MakiePlotMono(MonoPlot,POData2,TrajVarInc1_pos_stable_NoFric,col_o,ThreeD,AxisNum1,AxisNum2,AxisNum3,Mod,Transform,mks,lineplot,lw,gap=gap_line)
Makie.scale!(MonoPlot,1,1,0.1)
display(MonoPlot)
...
SecondCut4PiPoints=SecondCutFinalPoints[:,SecondCutFinalPoints[1,:].>4*π-0.01]

## Now plot the second cut final points with the stable tube
PoincarPlot=Scene()
Axis=0
CutDataL1_Stable,PoincarPlot=MakiePlotFinalPoint(PoincarPlot,TrajVarInc1_pos_stable_NoFric,col_o,Axis,LinePlot=1)
Makie.scatter!(PoincarPlot,SecondCut4PiPoints[2,:],SecondCut4PiPoints[4,:],color=col_p,markersize=3,strokewidth=0)
#
Makie.scale!(PoincarPlot,1,0.1)
display(PoincarPlot)
...
# Plot the result
PoincarPlot=Plots.scatter!(PoincarPlot,SecondCut4PiPoints[2,:],SecondCut4PiPoints[4,:],color=col_p,
    label="",markersize=1.5,markerstrokewidth=0,markerstrokealpha=0,framestyle=:box)
PoincarPlot=Plots.scatter!(PoincarPlot,CutDataL1_Stable[2,:],CutDataL1_Stable[4,:],color=col_o,
    label="",markersize=1.5,markerstrokewidth=0,markerstrokealpha=0,framestyle=:box)
display(PoincarPlot)

# Save the result
savefig(PoincarPlot,"Figures/EDP_L2_Tube_SecondCut.pdf")
...
MonoPlot=Scene()
gap_line=5
MakiePlotMono(MonoPlot,POData2,TrajVarInc1_pos_unstable_NoFric_ThirdCut_NoStop,col_p,ThreeD,AxisNum1,AxisNum2,AxisNum3,Mod,Transform,mks,lineplot,lw,gap=gap_line)
MakiePlotMono(MonoPlot,POData2,TrajVarInc1_pos_unstable_NoFric_SecondCut,col_p,ThreeD,AxisNum1,AxisNum2,AxisNum3,Mod,Transform,mks,lineplot,lw,gap=gap_line)
MakiePlotMono(MonoPlot,POData2,TrajVarInc1_pos_stable_NoFric,col_o,ThreeD,AxisNum1,AxisNum2,AxisNum3,Mod,Transform,mks,lineplot,lw,gap=gap_line)
Makie.scale!(MonoPlot,1,1,0.1)
display(MonoPlot)
...
ThirdCut6PiPoints=ThirdCutFinalPoints[:,ThirdCutFinalPoints[1,:].>6*π-0.01]
ThirdCut6PiPoints
## Plot the Poincare cut
PoincarPlot=Scene()
Axis=0
CutDataL1_Stable,PoincarPlot=MakiePlotFinalPoint(PoincarPlot,TrajVarInc1_pos_stable_NoFric,col_o,Axis,LinePlot=1)
Makie.scatter!(PoincarPlot,ThirdCut6PiPoints[2,:],ThirdCut6PiPoints[4,:],color=col_p,markersize=3,strokewidth=0)
#
Makie.scale!(PoincarPlot,1,0.1)
display(PoincarPlot)
...
PoincarPlot=Plots.plot(size=(650,400),tickfontsize=20)
# Plot the result
PoincarPlot=Plots.scatter!(PoincarPlot,ThirdCut6PiPoints[2,:],ThirdCut6PiPoints[4,:],color=col_p,
    label="",markersize=1.5,markerstrokewidth=0,markerstrokealpha=0,framestyle=:box)
PoincarPlot=Plots.scatter!(PoincarPlot,CutDataL1_Stable[2,:],CutDataL1_Stable[4,:],color=col_o,
    label="",markersize=1.5,markerstrokewidth=0,markerstrokealpha=0,framestyle=:box)
display(PoincarPlot)
...
# Save the result
savefig(PoincarPlot,"Figures/EDP_L2_Tube_ThirdCut.pdf")
