...
% This assumes the up positions is the zero angle
%y1=-y1;
%y2=-y2;
...
%% Solve for the expression of dtheta2 given energy level and dtheta1
syms EngTarget
EngSolve1=solve(simplify(Hamil)-EngTarget==0,dz1);
EngSolve2=solve(simplify(Hamil)-EngTarget==0,dz2);
simplify(EngSolve1(1))
simplify(EngSolve1(2))
simplify(EngSolve2(1))
simplify(EngSolve2(2))
...
%%
% Edit this part to determine whether you want the friction effect in the final model
% You can also make the double pendulum mounted by setting the acceleration
% of the cart as 0.
...
% Load or define the parameter values of the double pendulum here:
% load("EstimatedValueDou.mat")

% Substitude the variable as number
% Lag1Num=subs(Lag1,[m1 m2 a1 a2 I1 I2 k1 k2 g L1],[parsEsDou(1) parsEsDou(2) parsEsDou(3) parsEsDou(4) parsEsDou(5) parsEsDou(6) parsEsDou(7) parsEsDou(8) 9.818 0.2667]);
% Lag2Num=subs(Lag2,[m1 m2 a1 a2 I1 I2 k1 k2 g L1],[parsEsDou(1) parsEsDou(2) parsEsDou(3) parsEsDou(4) parsEsDou(5) parsEsDou(6) parsEsDou(7) parsEsDou(8) 9.818 0.2667]);
% HamilNum=subs(Hamil,[m1 m2 a1 a2 I1 I2 k1 k2 g L1],[parsEsDou(1) parsEsDou(2) parsEsDou(3) parsEsDou(4) parsEsDou(5) parsEsDou(6) parsEsDou(7) parsEsDou(8) 9.818 0.2667]);
% thisisddtheta1Num=simplify(subs(thisisddtheta1,[m1 m2 a1 a2 I1 I2 k1 k2 g L1],[parsEsDou(1) parsEsDou(2) parsEsDou(3) parsEsDou(4) parsEsDou(5) parsEsDou(6) parsEsDou(7) parsEsDou(8) 9.818 0.2667]));
% thisisddtheta2Num=simplify(subs(thisisddtheta2,[m1 m2 a1 a2 I1 I2 k1 k2 g L1],[parsEsDou(1) parsEsDou(2) parsEsDou(3) parsEsDou(4) parsEsDou(5) parsEsDou(6) parsEsDou(7) parsEsDou(8) 9.818 0.2667]));
...
% fprintf('\n\t ***The first EOM is:***\n')
% fprintf('\n\t %s \n',char(simplify(vpa(Lag1Num))))
%
% fprintf('\n\t The second EOM is:***\n')
% fprintf('\n\t %s \n',char(simplify(vpa(Lag2Num))))
